...
api_id = '26524723'
api_hash = '9443fff1a8fa1911f71766c682d4372f'
bot_token = '7692407554:AAHLxcWRFNeohEb2orgxhBF5kaRSpJsKS7g'

client = TelegramClient('bot', api_id, api_hash).start(bot_token=bot_token)

# ID do chat (substitua pelo seu chat ID real)
chat_id =  -1002399634661  # Certifique-se de que está correto
...
async def send_pre_message():
    try:
        await client.send_file(
            chat_id,
            'mppy.img1.jpg',  # Certifique-se de que a imagem está no mesmo diretório que o script
...
"""
        ...
        await client.send_message(chat_id, message, buttons=buttons, file='mppy.img2.jpg')
    except Exception as e:
